...
public interface DeviceTokenRepository {
	...
	Optional<DeviceToken> findByMemberIdAndDeviceType(Long memberId, String token); // 운영/정합 목적

	/** 조회(읽기) 중심 **/
	List<String> findActiveTokensByMemberIds(List<Long> memberIds);

	boolean existsActiveByMemberIdAndDeviceType(Long memberId, String token);
